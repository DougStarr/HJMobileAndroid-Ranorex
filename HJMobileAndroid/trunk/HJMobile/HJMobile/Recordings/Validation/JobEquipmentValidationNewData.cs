...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The JobEquipmentValidationNewData recording.
    /// </summary>
    [TestModule("b4495cd0-ca16-4593-83a7-d432da02779a", ModuleType.Recording, 1)]
    public partial class JobEquipmentValidationNewData : ITestModule
    {
        /// <summary>
        ...
        static JobEquipmentValidationNewData instance = new JobEquipmentValidationNewData();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public JobEquipmentValidationNewData()
        {
        }
        ...
        /// </summary>
        public static JobEquipmentValidationNewData Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (Text='NEWEQP') on item 'ComHcssHcssmobileTesting.Content1.NEWEQP'.", repo.ComHcssHcssmobileTesting.Content1.NEWEQPInfo, new RecordItemIndex(4));
                Validate.Attribute(repo.ComHcssHcssmobileTesting.Content1.NEWEQPInfo, "Text", "NEWEQP", Validate.DefaultMessage, false);
                Delay.Milliseconds(100);
