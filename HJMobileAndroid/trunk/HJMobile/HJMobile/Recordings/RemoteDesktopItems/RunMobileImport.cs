...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The RunMobileImport recording.
    /// </summary>
    [TestModule("b42b68d8-f871-436e-a7d8-9b8d462cbd12", ModuleType.Recording, 1)]
    public partial class RunMobileImport : ITestModule
    {
        /// <summary>
        ...
        static RunMobileImport instance = new RunMobileImport();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public RunMobileImport()
        {
        }
        ...
        /// </summary>
        public static RunMobileImport Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '\\heavyjob\\bin\\mobileimport.exe{Return}'.", new RecordItemIndex(6));
            Keyboard.Press("\\heavyjob\\bin\\mobileimport.exe{Return}");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Delay", "Waiting for 5m.", new RecordItemIndex(7));
...
#region Image Feature Data
        ...
        { get { return Imaging.FindOptions.Parse("0.93;None;0,0,0,0;True;10000000;60000ms"); } }
